...
["__emscripten_thread_init","__emscripten_thread_exit","__emscripten_thread_crashed","__emscripten_thread_mailbox_await","__emscripten_tls_init","_pthread_self","checkMailbox","establishStackSpace","invokeEntryPoint","PThread","___indirect_function_table","__emscripten_proxy_main","_main","onRuntimeInitialized"].forEach((prop) => {
...
// end include: preamble.js
  ...
  allocateUnusedWorker() {
        ...
        var pthreadMainJs = locateFile('chdman.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(9, 0, 1, fd,length_low, length_high);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, fd, backlog);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 0, 1, fd,iov,iovcnt,offset_low, offset_high,pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(23, 0, 1, fd,iov,iovcnt,offset_low, offset_high,pnum);
